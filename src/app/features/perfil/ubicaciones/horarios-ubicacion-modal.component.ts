          ...
          <div class="mb-6">
            ...
            @if (!loading() && horarios().length === 0) {
              <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p class="text-sm text-gray-500 mt-1">Agrega tu primer horario de atención abajo</p>
              </div>
            }
          ...
          <div class="border-t border-gray-200 pt-6">
            <div class="flex border-b border-gray-200 mb-6">
              <button
                ...
                [class]="activeTab() === 'rapida' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-gray-700'"
              ...
              <button
                ...
                [class]="activeTab() === 'individual' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-gray-700'"
                class="px-6 py-3 font-medium text-sm transition-colors">
                Agregar Individual
              </button>
            </div>

            <!-- Tab Content: Inicialización Rápida -->
            @if (activeTab() === 'rapida') {
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Configuración Rápida de Horarios</h3>
                <p class="text-sm text-gray-600 mb-4">Selecciona múltiples días y aplica el mismo horario a todos</p>
                ...
                <form [formGroup]="rapidaForm" (ngSubmit)="onSubmitRapida()" class="space-y-4">
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                      @for (dia of diasSemana; track dia.value) {
                        <label
                          ...
                          [class.bg-blue-50]="isDiaSelected(dia.value)"
                          [class.border-blue-500]="isDiaSelected(dia.value)">
                          <input
                            type="checkbox"
                            [value]="dia.value"
                    ...
                    @if (rapidaForm.get('dias')?.invalid && rapidaForm.get('dias')?.touched) {
                      <p class="mt-1 text-sm text-red-600">Selecciona al menos un día</p>
                    }
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Duración de Cita -->
                    <div>
                      <label for="duracionRapida" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <!-- Hora Inicio -->
                    <div>
                      <label for="horaInicioRapida" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <!-- Hora Fin -->
                    <div>
                      <label for="horaFinRapida" class="block text-sm font-medium text-gray-700 mb-1">
            ...
            <!-- Tab Content: Agregar Individual -->
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      @if (horarioForm.get('horaFin')?.invalid && horarioForm.get('horaFin')?.touched) {
                        <p class="mt-1 text-sm text-red-600">La hora de fin es requerida</p>
                      }
                    </div>
                  </div>
...
export class HorariosUbicacionModalComponent implements OnInit {
  ...
  isDiaSelected(dia: DiaSemana): boolean {
    ...
    return currentDias.includes(dia);
  }
  ...
  private handleErrorRapida(err: any): void {
    console.error('Error saving rapida horarios:', err);
    ...
    if (err.error?.message) {
      ...
      this.errorMessageRapida.set('Error al aplicar los horarios. Verifique que no haya conflictos con otros horarios existentes.');
    }
  }
